...
public class ModEntityModelLayers {
	public static final ModelLayerLocation ASIAN_DAD = createMain("asian_dad");

	private static ModelLayerLocation createMain(String name) {
		return new ModelLayerLocation(Identifier.fromNamespaceAndPath(AsianMod.MOD_ID, name), "main");
	}
