package org.spearedrice.asianmod.rendering.screens.inventory;
...
public class BrassChestScreen extends AbstractContainerScreen<BrassChestMenu> {
    private static final Identifier CONTAINER_TEXTURE = Identifier.withDefaultNamespace("textures/gui/container/dispenser.png");

    public BrassChestScreen(BrassChestMenu abstractContainerMenu, Inventory inventory, Component component) {
