...
public class UpgradingRecipeSerializer implements RecipeSerializer<UpgradingRecipe> {
    ...
    public static final MapCodec<UpgradingRecipe> CODEC =
            RecordCodecBuilder.mapCodec(instance ->
                    instance.group(
                            ItemStack.STRICT_CODEC.fieldOf("result")
                                    .forGetter(UpgradingRecipe::getResult),

                            Ingredient.CODEC.fieldOf("baseItem")
                                    .forGetter(UpgradingRecipe::getBaseItem),

                            Ingredient.CODEC.fieldOf("upgradeItem")
                                    .forGetter(UpgradingRecipe::getUpgradeItem)
                    ).apply(instance, UpgradingRecipe::new)
            );

    public static final StreamCodec<RegistryFriendlyByteBuf, UpgradingRecipe> STREAM_CODEC =
